...
parser.add_argument('--data_path', type=str, default='/home/share/hanxianjing/activityNet/', help='dataset path')
...
train_dataset = Activitynet_Train_dataset(opt.data_path)
test_dataset = Activitynet_Test_dataset(opt.data_path)
